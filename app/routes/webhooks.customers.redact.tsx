 ...
 * requested erasure. authenticate.webhook(request) verifies the HMAC
 ...
 * to redact, so acknowledging with 200 and no further action is the
 * correct, complete response — not a stub standing in for missing logic. */
